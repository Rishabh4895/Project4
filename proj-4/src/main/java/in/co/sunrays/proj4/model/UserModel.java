...
public class UserModel {
	...
	public Integer nextPk() throws DatabaseException {
		...
		System.out.println("user model next pk" + pk);
		return pk + 1;
	}
	...
	public long add(UserBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			conn = JDBCDataSource.getConnection();
			pk = nextPk();
			System.out.println("user model add" + pk);
			// get AutoGenerated next Primary Key
		...
		System.out.println("user model add 147" + pk);
		return pk;
	}
	...
	public void update(UserBean bean) throws ApplicationException, DuplicateRecordException {
		...
		// check if updated login already exist
	...
	public boolean changePassword(Long id, String oldPassword, String newPassword)
		...
		if (beanExist != null && beanExist.getPassword().equals(oldPassword)) {
			...
			try {
				update(beanExist);
				// System.out.println("model Password updated");
			} catch (DuplicateRecordException e) {
				log.error(e);
				// System.out.println("model Password duplicate");
				throw new ApplicationException("Login id already exist");
			}
			flag = true;
		} else {
			// System.out.println("model Record not found");
		...
		// System.out.println("model changePassword Ended");
	 ...
	 */
	public long registerUser(UserBean bean) throws ApplicationException, DuplicateRecordException, MessagingException {

		/*
		 * log.debug("Model add Started");
		 * 
		 * try { URL url = new URL("https://www.google.co.in"); URLConnection connection
		 * = url.openConnection(); connection.connect();
		 * System.out.println("Internet Connected"); } catch (IOException e) { //
		 * System.out.println(e); throw new MessagingException(); }
		 * 
		 * long pk = add(bean);
		 * 
